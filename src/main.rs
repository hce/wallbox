...
fn main() {
    ...
    let e3dc = E3DC::new("localhost", 5020, std::time::Duration::from_secs(2))
        .expect("Create e3dc object");
    let mennekes = Mennekes::new("localhost", 5021, std::time::Duration::from_secs(60))
        .expect("Create mennekes object");
    let pac2200 = Pac2200::new("localhost", 5022, std::time::Duration::from_secs(1))
